...
$get_keyword_idx_query = "SELECT name FROM keyword WHERE idx = :idx";
$get_keyword_idx_stmt = $DB_con->prepare($get_keyword_idx_query);
$get_keyword_idx_stmt->bindParam(":idx", $key_idx);
$get_keyword_idx_stmt->execute();

$keyword = urlencode($get_keyword_idx_stmt->fetch(PDO::FETCH_ASSOC)["name"]);
