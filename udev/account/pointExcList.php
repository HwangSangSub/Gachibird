...
?>
<script type="text/javascript" src="<?= UDEV_DIR ?>/member/js/memberManager.js"></script>
			...
			<form class="local_sch03 local_sch" autocomplete="off">
				...
				<div class="local_desc01 local_desc">
					<p>
						...
						현재 설정된 수수료는 <a href="<?= UDEV_DIR ?>/config/configExcReg.php"><span style="font-weight:bold; color:red;"><?= $con_Tax ?></span></a> % 입니다.<br>
					</p>
				</div>
			</form>
